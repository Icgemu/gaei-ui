...
class Taskbar extends React.Component {
    ...
    render() {
      ...
      let lis = this.props.tabs.map(option=>{
        return (
          <li >
          <div styleName="taskbutton" onClick={e=>{this.props.addModal(option)}}>
              <span>
                  <i className="fa fa-th-large"></i>&nbsp;{option.title}
              </span>
          </div>
          <div styleName = "close"  onClick={e=>{this.props.close(option.id)}}> <i className="fa fa-times-circle"></i> </div>
          </li>
        )
      })
        ...
        return (
            <div styleName="taskbar" style={{left:'0px',bottom:'0px'}}>
