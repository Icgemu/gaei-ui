      ...
      return (
        <div className={styles.headerInfo}>
            <ul className={styles.headerInfoList}>
                ...
                <a href="#" className="dropdown-toggle" data-toggle="dropdown">我的账户 <span className="caret"></span></a>
                    <ul className={drop} role="menu">
                        <li><a href="#" data-toggle="dialog" data-id="changepwd_page" data-mask="true" data-width="400" data-height="260">&nbsp;<span className="glyphicon glyphicon-lock"></span> 修改密码</a></li>
